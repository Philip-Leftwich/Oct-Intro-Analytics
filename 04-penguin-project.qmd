...
* Go to RStudio Cloud and make a new R Project - from template: 5027A

* Call your project 'Penguins'
...
Check out @sec-workflow for more information on filepaths and data management.
...
Scripts are a human readable record of our analysis - we need them to be organised, consistent, and well-documented. See @sec-scripts for general tips on how to do this. 
