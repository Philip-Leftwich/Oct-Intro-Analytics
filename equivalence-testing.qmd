...
gg_rope <- ggplot(df2, aes(x2, y2)) +
  ...
  labs(
    ...
    subtitle = "Most of the effect distribution lies within the ROPE → evidence for practical equivalence",
    x = "Effect size",
    y = "Density"
  ) +
  theme_minimal(base_size = 14) +
...
Let’s say a difference smaller than 40 g is biologically negligible.
We define a ROPE (Region of Practical Equivalence) as ±40 g.

equivalence_test(m, range = c(-40, 0))
...
- Even though the treatment effect was “statistically significant” (p = 0.04), the equivalence test says it’s practically negligible in biological terms.
