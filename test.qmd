...
-   `theme_light()`: A light theme with gray gridlines for subtle guidance.
...
In ggplot2, colors that are assigned to variables are modified via the scale_color\_\* and the scale_fill\_\* functions. In order to use color with your data, most importantly you need to know if you are dealing with a categorical or continuous variable. The color palette should be chosen depending on type of the variable:
