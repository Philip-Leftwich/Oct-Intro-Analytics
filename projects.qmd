...
- Use the fs package to create and navigate folders within an R project.
...
## Why using projects matters

:::{.callout-tip}

## How do you organise your R workflow?
...
In RStudio, a project is a way to organize your work . It's a fundamental concept designed to enhance your workflow by providing a structured and efficient means of managing your R-related tasks and files. Here's why R projects are useful:
...
Run `dir_tree()` to generate a nicely formatted directory tree and is a great sanity check before and after file manipulation
