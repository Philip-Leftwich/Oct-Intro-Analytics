...
With our data we can count the total number of occurrences for different groups:
...
Or grouped by another variable such as sex:
...
- Standard deviation (SD) shows how spread out the values are — a large SD means more variability.

- Missing values are removed with `na.rm = TRUE`.
