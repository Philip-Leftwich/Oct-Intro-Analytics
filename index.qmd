...
knitr::write_bib(c(
  .packages(), 'rstatix', 'patchwork', 'here', 'kableExtra', 'plotly', 'gitcreds', 'usethis', 'ggridges', 'scales', 'purrr', 'tinytex', 'gt', 'broom', 'tidyverse','styler', 'rstatix', 'performance', 'see', 'lme4', 'lmerTest', 'DHARMa', 'glmmTMB', 'nlme', 'ggeffects', 'sjPlot', 'DHARMa', 'report', 'MuMIn', 'palmerpenguins', 'colorBlindness', 'skimr', 'ggplot2', 'sandwich', 'parameters', 'esquisse', 'plotly', 'assertr', 'showtext', 'sysfonts', 'ggforce', 'geomtextpath', 'ggtext', 'gghighlight', 'ggh4x', 'ggbeeswarm', 'fs', 'glue', 'janitor', 'palmerpenguins', 'camcorder'
