...
knitr::write_bib(c(
  .packages(), 'rstatix', 'patchwork', 'here', 'kableExtra', 'plotly', 'ggridges', 'scales', 'purrr', 'gt', 'broom', 'tidyverse','styler', 'performance', 'see', 'lme4', 'lmerTest', 'DHARMa', 'glmmTMB', 'nlme', 'ggeffects', 'sjPlot', 'report', 'MuMIn', 'palmerpenguins', 'colorBlindness', 'skimr', 'ggplot2', 'sandwich', 'parameters', 'esquisse', 'assertr', 'showtext', 'sysfonts', 'ggforce', 'geomtextpath', 'ggtext', 'gghighlight', 'ggh4x', 'ggbeeswarm', 'fs', 'glue', 'janitor', 'camcorder', 'gghalves', 'dplyr', 'colorspace', 'easystats', 'gtsummary', 'naniar', 'DescTools', 'lubridate'
